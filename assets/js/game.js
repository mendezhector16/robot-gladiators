...
var fight = function(enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
      if (isPlayerTurn){
          //ask player if they would like to fight or skip using the fightOrSkip()
          if (fightOrSkip()) {
  ...
  //switch tur order for next round
...
//after the look ends, player is either out of health or enemies o fight, so run the endGame function
endGame();
